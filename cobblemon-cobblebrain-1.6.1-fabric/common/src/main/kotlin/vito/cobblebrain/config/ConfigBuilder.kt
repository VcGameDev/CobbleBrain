...
class ConfigBuilder<T> private constructor(
    ...
    private fun writeFile(file: File, gson: Gson, json: JsonObject) {
        ...
        val comments = mapOf(
            ...
            "\"maxStoredMemories\"" to "\n// Maximum stored memory size per Pokémon. Controls how many memories are kept in the jsonl history.",
            "\"maxRelevantMemories\"" to "\n// Maximum relevant memories retrieved and sent in the prompt.",
            "\"lastRetrievedMemoryCount\"" to "\n// Maximum size of the cache of recently used/retrieved memories.",
            "\"lastRetrievedMemoryLifetime\"" to "\n// Number of interactions a retrieved memory stays in the cache.",
